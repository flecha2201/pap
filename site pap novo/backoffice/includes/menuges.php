<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <div class="container-fluid w-100">
    ...
    <img src="<?php echo $_SESSION['foto_ut']; ?>" class="rounded-circle me-2" style="width: 40px; height: 40px; object-fit: cover;">
    <a class="nav-link" href="index.php?cmd=logout" title="Logout">
    <i class="bi bi-box-arrow-right" style="padding-left: 15px; font-size: 1.5rem; color: white;"></i>
    </a>
    </div>
  </div>
</nav>
