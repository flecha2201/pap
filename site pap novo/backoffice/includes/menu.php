...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <div class="container-fluid w-100">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="index.php?cmd=addgest">Inserir Gestores</a></li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="index.php?cmd=addut">Inserir Utilizador</a></li>
    ...
    <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="index.php?cmd=addfat">Inserir Faturas</a></li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="index.php?cmd=addcat">Inserir Categorias</a></li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="index.php?cmd=addcatprod">Inserir Categorias de Produtos</a></li>
            <li><a class="dropdown-item" href="index.php?cmd=liscatprod">Listar Categorias de Produtos</a></li>
          </ul>
        </li>
		<li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">Encomendas</a>
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="index.php?cmd=addencomenda">Inserir Encomendas</a></li>
            <li><a class="dropdown-item" href="index.php?cmd=lisencomenda">Listar Encomendas</a></li>
          </ul>
        </li>
